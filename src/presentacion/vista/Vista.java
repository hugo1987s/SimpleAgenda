...
public class Vista
{
	...
	private void initialize()
	{
		...
		frmAgenda.setIconImage(Toolkit.getDefaultToolkit().getImage("imagenes\\agenda.png"));
		frmAgenda.setBounds(100, 100, 947, 308);
		...
		btnReporteXFecha.setBounds(550, 228, 156, 23);
